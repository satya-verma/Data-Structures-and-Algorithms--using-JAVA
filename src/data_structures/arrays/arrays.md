...
=> In this section we will build our own dynamic array data structure which will have methods like get, push, pop, shift, delete, insert.
=> shift method removes the first element of an array.___  
